...
why: {
    eyebrow: 'პრობლემა',
    titlePre: 'თუ საქართველოში ცხოვრობ, ',
    titleAccent: 'ნამდვილი',
    titlePost: ' სისტემა, რომელიც დაგეხმარება მართო შენი ხარჯები, არ გაქვს.',
    intro: {
      prefix:
        'არც ერთი ქართული ბანკი არ აქვეყნებს ტრანზაქციების საჯარო API-ს. არ არსებობს პლატფორმა, რომელზეც მზა გადაწყვეტას ააწყობ. შესაბამისად, ვერც ',
      monarchText: 'Monarch',
      ...
      suffix:
        ' ან სხვა მსგავსი ხელსაწყოები ჩვენს ბანკებს ვერ უკავშირდება. რაც შეეხება BOG-ს და TBC-ს საკუთარ აპებს, მათ ანალიტიკას აკლია ელემენტარული: პერსონალური დინამიური კატეგორიები, მოქნილი ფილტრები, ხარჯის პატერნის სწავლა, cross banking ხარჯვა და AI ინსაითები',
    },
    cards: [
      {
        tag: '01 · Barrier',
        title: 'API არ არსებობს.',
        body: 'არც ერთი ქართული ბანკი არ იძლევა ტრანზაქციებზე წვდომას. არც OAuth, არც Plaid. საკუთარი ფინანსური მონაცემების პროგრამულად წაკითხვა საქართველოში შეუძლებელია.',
        stat: '0',
        statLabel: 'ბანკი საჯარო API-ით',
      },
      {
        tag: '02 · Limits',
        title: 'საბანკო აპები არ მუშოაბენ ისე როგორც საჭიროა.',
        body: 'ფიქსირებული კატეგორიები, რომლებსაც ვერ შეცვლი. ბანკთაშორისი ხედვის დეფიციტი და ლიმიტირებული ექსპორტი. ეს აპები ბალანსის შესამოწმებლად კარგია, მაგრამ ხარჯების სიღრმისეული ანალიზისთვის არა.',
        stat: '✕',
        statLabel: 'საკუთარი კატეგორიები ან ფილტრები',
      },
      {
        tag: '03 · The Hack',
        title: 'მაგრამ SMS-ები ყველას მოგვდის ჩვენს მობილურ მოწყობილებებზე.',
        body: 'ყოველი გადახდისას ბანკი სტრუქტურირებულ SMS-ს გიგზავნის. თუ ჩართული გაქვს სინქრონიზაცია Mac-ის Messages.app-თან, ეს მონაცემები უკვე ინახება შენს ლოკალურ SQLite ფაილში, მათ მხოლოდ დამუშავება სჭირდებათ.',
        stat: '100%',
        statLabel: 'მონაცემები უკვე შენს Mac შია',
      },
    ],
    aha: {
      eyebrow: 'Aha! Moment',
      quoteLine1: '„თუ SMS შეტყობინებები ჩართულია, ყოველი ტრანზაქცია უკვე ჩემს ჯიბეშია.',
      quoteLine2: 'უბრალოდ დამუშავებაა საჭირო.“',
      body:
        'macOS ავტომატურად აკოპირებს iPhone-ის SMS-ებს ლოკალურ SQLite ბაზაში. გადახდის დასტური, უარყოფილი ტრანზაქცია თუ ავტომატური ჩამოჭრა — ყველაფერი იქ არის, ზუსტი დროითა და ტექსტით. Xarji უბრალოდ კითხულობს ამ მონაცემებს და ქმნის სტრუქტურიზებულ მონაცემებს, გიმზადებს ხელსაწყოებს Dashboard ში რომ სიღმისეულად აკონტროლო შენი ხარჯები',
      tagline: 'მუშაობს დამოუკიდებლად, დამატებითი API ების გარეშე.',
      flow: {
        iphoneLabel: 'შენი iPhone',
        iphoneSub: 'ბანკის SMS მოდის',
        iphoneMeta: 'BOG / TBC',
        iphoneToMac: 'iCloud Messages · Sync ჩართულია',
        macLabel: 'Messages.app (Mac)',
        macSub: 'SMS ინახება ლოკალურ SQLite-ში',
        macMeta: '~/Library/Messages/chat.db',
        macToXarji: 'Read-only წვდომა',
        xarjiLabel: 'Xarji',
        xarjiSub: 'Categorized · Charts · Local',
        xarjiMeta: 'InstantDB · ლოკალური',
      },
    },
  },
  ...
  download: {
    ...
    releaseNotes: [
      'AI Assistant-ს ახლა შეუძლია კატეგორიების შექმნა და ტრანზაქციების გადანაწილება — მაგ. "შექმენი Coffee shops კატეგორია და გადაიტანე Skola-ს ტრანზაქციები იქ"',
      'Assistant ახლა ინახავს საუბრის ისტორიას, შეგიძლია მისცე follow-up კითხვები',
      'ინტერაქტიული გრაფიკები: მაუსის გადატარება — tooltip წინა პერიოდთან შედარებით, კლიკი სლაისზე ან ბარზე — გადადის ფილტრირებულ ტრანზაქციებზე',
      'Today / Week / Month / Year / Custom ღილაკები ახლა ფილტრავს ყველა გვერდს',
      '"Sync now" ღილაკი Manage → Data sources-ში — SMS-ების ხელით განახლებისთვის',
      'Light mode-ის გასწორება: გვერდის გახსნისას აღარ ჩნდება მუქი ფერი ერთი წამით',
      'Demo რეჟიმი (?demo=1 dev-ში) დემო-ჩანაწერებისთვის — სრული მონაცემთა ნიმუშით',
    ],
    previousLabel: 'წინა ვერსიები',
    priorDownloadLink: 'ჩამოტვირთვა →',
    priorSummaries: {
      '0.2.5': 'მრავალვალუტიანი ჯამები · NBG გაცვლითი კურსი · TBC პარსერის გასწორება',
      '0.2.4': 'ინსტალაცია macOS-ის სრულფასოვანი პროგრამის სახით · სერვისთან კავშირის შეცდომის ეკრანი',
  ...
  newsletter: {
    ...
    errorTitle: 'ვერ დავუკავშირდით გამოწერის სერვისს.',
    errorSub: 'ცოტას დაელოდე და კიდევ სცადე.',
