...
export const ka: Copy = {
  ...
  why: {
    eyebrow: 'პრობლემა',
    titlePre: 'თუ საქართველოში ცხოვრობ, არ გაქვს ',
    titleAccent: 'ნამდვილი',
    titlePost: ' ხარჯების მთვლელი.',
    intro: {
      prefix:
        'არც ერთი ქართული ბანკი არ აქვეყნებს ტრანზაქციების საჯარო API-ს. არაფერი, რაზეც რამე შეიძლება აშენდეს. არაფერი, რომელთანაც ',
      monarchText: 'Monarch',
      ...
      suffix:
        ', ან ნებისმიერი სხვა ინსტრუმენტი, რომელსაც დანარჩენი მსოფლიო იყენებს, შეუერთდებოდა. BOG-სა და TBC-ს საკუთარი აპის ანალიტიკა? საკუთარი კატეგორიები არ აქვს. ნამდვილი ფილტრები არ აქვს. არც ტრენდები, რომლებიც მეორე შეხედვას იმსახურებდა.',
    },
    cards: [
      {
        tag: '01 · ნაპრალი',
        title: 'API არსად.',
        body: 'BOG, TBC — არც ერთი მათგანი არ აქვეყნებს ტრანზაქციების endpoint-ს. არც OAuth, არც OFX, არც Plaid. საკუთარი ფულის პროგრამულად წაკითხვა შეუძლებელია.',
        stat: '0',
        statLabel: 'ქართული ბანკი საჯარო API-ით',
      },
      {
        tag: '02 · კედლები',
        title: 'მშობლიური აპები ჩიხია.',
        body: 'ფიქსირებული კატეგორიები, რომელთა სახელის შეცვლა შეუძლებელია. არ არის ბანკთაშორისი ხედვა. ექსპორტი, რომელიც ბოლო თვეზე ჩერდება. ბალანსის შესამოწმებლად გამოდგება, ხარჯების გასაგებად — უკვე არა.',
        stat: '✕',
        statLabel: 'საკუთარი კატეგორიები, ფილტრები ან ტრენდები',
      },
      {
        tag: '03 · ხრიკი',
        title: 'მაგრამ SMS-ები უკვე აქ არის.',
        body: 'ყველა ქართული ბანკი აგზავნის სტრუქტურირებულ SMS-ს, როგორც კი ბარათს მიეხები. თუ ეს SMS-ები ტელეფონიდან Mac-ის Messages.app-ში სინქრონიზდება, მონაცემები ლოკალურ SQLite ფაილში ზის — მხოლოდ დამუშავება ელოდებათ.',
        stat: '100%',
        statLabel: 'ტრანზაქციების, რომლებიც უკვე შენს Mac-ზეა',
      },
    ],
    aha: {
      eyebrow: 'გამოცხადება',
      quoteLine1: '„თუ SMS-ის შეტყობინებები ჩართულია, ყოველი ტრანზაქცია ჩემს ჯიბეშია.',
      quoteLine2: 'უბრალოდ ლეპტოპი უნდა გავხსნა."',
      body:
        'macOS უკვე სინქრონიზებს iPhone-ის SMS-ებს ლოკალურ SQLite ბაზაში. ყოველი გადახდის დადასტურება, ყოველი უარყოფილი ბარათი, ყოველი ავტომატური გადახდა — ყველაფერი იქ არის, დროის შტამპით, წმინდა ტექსტად. Xarji კითხულობს, ამუშავებს და აშენებს იმ დეშბორდს, რომელზეც ბანკებმა უარი თქვეს.',
      tagline: 'ცოტა ხრიკიანი. მთლიანად ლოკალური. მუშაობს BOG-ის თანხმობის გარეშეც.',
      flow: {
        iphoneLabel: 'შენი iPhone',
        iphoneSub: 'ბანკის SMS მოდის',
        iphoneMeta: 'BOG / TBC',
        iphoneToMac: 'iCloud Messages · გადაცემა ჩართულია',
        macLabel: 'Messages.app Mac-ზე',
        macSub: 'SMS სინქრონიზებულია ლოკალურ SQLite-ში',
        macMeta: '~/Library/Messages/chat.db',
        macToXarji: 'მხოლოდ წაკითხვა · Mac-ს არასდროს ტოვებს',
        xarjiLabel: 'Xarji',
        xarjiSub: 'კატეგორიზებული · გრაფიკებით · შენი',
