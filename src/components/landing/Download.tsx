...
export default function Download({ copy, locale, release }: Props) {
  ...
  return (
    <section
      id="download"
      style={{ padding: "var(--sv) var(--sh)", position: "relative" }}
    >
      <div
        aria-hidden
        style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
        ...
        >
          ...
          >
            ...
            >
              {copy.xarjiForPre}
              <span style={{ color: LAND.accent }}>{copy.xarjiForAccent}</span>
            </h3>
            <div
              style={{
                marginTop: 10,
